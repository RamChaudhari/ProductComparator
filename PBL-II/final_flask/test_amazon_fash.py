...
def search(search_term):
    ...
    for product in products[:5]:
        product_name = product.find('span', attrs={"class": 'a-size-base-plus a-color-base'}).text.strip()
        ...
        current_product = {
            ...
            'productURL': initURL+product_url,
        }
